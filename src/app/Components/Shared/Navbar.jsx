...
export default function Navbar() {
  ...
  return (
    <div className='flex justify-between px-4 py-6 rounded-xl bg-local text-white mt-2'>
      ...
      <div className='flex items-center'>
        <Link href={'https://drive.google.com/file/d/18jftyjlhRyItWteE-Os47R7y0GIzceed/view?usp=drive_link'} target='_blank' className='btn btn-outline rounded-badge text-white'>Resume</Link>
      </div>
    </div>
  )
}
